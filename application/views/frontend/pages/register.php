...
<head>
  ...
  <title>Rejestracja - VideoGamesHub</title>
              ...
              <div class="card-body">
                ...
                <form method="post" action="<?php echo base_url(); ?>users/register">
                  ...
                  <h3 class="dark-grey-text text-center">
                    <strong>Zarejestruj się na VideoGamesHub</strong>
                  </h3>
                  ...
                  <div class="form-check">
                    <input type="checkbox" id="regulations" class="form-check-input" required>
                    <label class="form-check-label" for="regulations">Akceptuje <a target="_blank" href="<?= base_url('rejestracja-regulamin') ?>">regulamin</a></label>
                  </div>
                ...
                <button type="button" class="btn btn-dark"><a class="text-white" href="<?= base_url('logowanie'); ?>">Przejdź do ekranu logowania</a></button>  
                </div>
