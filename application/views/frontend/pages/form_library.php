            ...
            <div class="row text-center">
                ...
                <div class="col-md-12 mt-5 mb-5">
                    ...
                    <section class="wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <h3 class="font-weight-bold black-text text-center">Formularz dodawania gry do bilbioteki</h3>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="PersonalData" role="tabpanel">
                                <br>
                                <form action="<?php echo base_url(); ?>library/action/<?php echo $this->uri->segment(3); ?>/library/<?= @$value->id; ?>" method="post" class="modal-body mb-1" enctype="multipart/form-data">
                                    <div class="row text-center">
                                        ...
                                        <div class="col-md-12 mt-5">
                                            <div class="md-form">
                                                <input type="text" id="title" class="form-control mb-4" placeholder="Tytuł gry" value="<?= @$value->title; ?>" name="title" required>
                                            </div>
                                            <div class="md-form">
                                                <input type="text" id="title" class="form-control mb-4" placeholder="Platforma" value="<?= @$value->platform; ?>" name="platform" required>
                                            </div>
