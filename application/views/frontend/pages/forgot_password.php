...
<head>
    ...
    <title>Zapomniałeś hasła ? - VideoGamesHub</title>
                    ...
                    <div class="col-md-6 col-xl-5 mb-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="<?= base_url('zapomnialem_hasla'); ?>">

                                    <h3 class="dark-grey-text text-center">
                                        <strong>Resetowanie hasła do VideoGamesHub</strong>
                                    </h3>
                                    ...
                                    <div class="text-left">
                                        <button type="submit" class="btn btn-dark">Resetuj hasło</button>
                                    </div>
                                ...
                                <button type="button" class="btn btn-dark"><a class="text-white" href="<?= base_url(); ?>users">Przejdź do ekranu logowania</a></button>  
                                </div>
