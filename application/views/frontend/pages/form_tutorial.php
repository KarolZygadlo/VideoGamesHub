        ...
        <section class="text-center team-section wow fadeIn" data-wow-delay="0.3s">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-12 mt-5 mb-5">
                    ...
                    <h3 class="font-weight-bold black-text text-center">Formularz dodawania poradnika</h3>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="PersonalData" role="tabpanel">
                                <br>
                                <form action="<?php echo base_url(); ?>tutorials/action/<?php echo $this->uri->segment(3); ?>/tutorials/<?= @$value->id; ?>" method="post" class="modal-body mb-1" enctype="multipart/form-data">
                                <div class="row text-center">
                                <div class="col-md-12 mt-5">
                                    ...
                                    <div class="col-md-12 mt-5">
                                        ...
                                        <input type="text" id="book_title" class="form-control mb-4"
                                               placeholder="Tytuł poradnika" value="<?= @$value->book_title; ?>" name="book_title" required>
                                        </div>
                                        <div class="md-form">
                                        <input type="text" id="book_title" class="form-control mb-4"
                                               placeholder="Tytuł gry" value="<?= @$value->game_title; ?>" name="game_title" required>
                                        </div>
