<main>
  <div class="page__section mb-5">
      <nav class="breadcrumb breadcrumb_type5 elegant-color-dark" aria-label="Breadcrumb">
        <ol class="breadcrumb__list r-list">
          ...
          <li class="breadcrumb__group">
            <span class="breadcrumb__point text-uppercase" aria-current="page">Lista gier</span>
          </li>
        </ol>
      </nav>
  </div>   
  <div class="container-fluid">
    ...
    <div class="card card-cascade narrower mb-5">
      ...
      <div class="view view-cascade elegant-color-dark narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">

        <div class="md-form my-0">
          <a href="" class="white-text mx-3">Lista gier</a>
        </div>



        <div class="text-right" style="width: 181px;">
          <a href="<?= base_url(); ?>backend/gamezone/form/insert">
