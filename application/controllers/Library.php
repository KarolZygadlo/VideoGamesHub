...
class Library extends CI_Controller {
	...
	public function index() {
		...
		$data['rows'] = $this->backend->get_all_records('library');
		echo frontView('list_library', $data);
	...
	public function form($type, $id = '') {
        ...
        if($id != '') {
			$data['value'] = $this->backend->get_one_record('library', $id);
        }
		echo frontView('form_library', $data);
	} 
	...
	public function action($type, $table, $id = '') {
			...
			redirect('twoja-biblioteka-gier');
